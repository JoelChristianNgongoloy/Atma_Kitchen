...
import { getSelesaikanPesanan, updatePesananMenjadiSelesai } from "../../../api/AdminApi/apiUpdateStatus";
...
const UpdateStatus = () => {
  ...
  const fetchPesanan = async () => {
    setIsPending(true);
    try {
      const data = await getSelesaikanPesanan();
      setPesanan(data);
      setIsPending(false);
    } catch (error) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (selectedPesanan) {
        await updatePesananMenjadiSelesai(selectedPesanan);
