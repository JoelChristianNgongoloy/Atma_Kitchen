                          ...
                          {laporan
                              ...
                              .map((item, index) => (
                                  <tr key={index}>
                                      ...
                                      <td className="border-b border-blue-gray-100 p-4">{formatCurrency(parseFloat(item.honor_harian) || 0)}</td>
                                      <td className="border-b border-blue-gray-100 p-4">{formatCurrency(parseFloat(item.bonus_rajin) || 0)}</td>
                                      <td className="border-b border-blue-gray-100 p-4">{formatCurrency(parseFloat(item.total) || 0)}</td>
                                  </tr>
                              ))}
                              <tr>
                                    <td colSpan={5} className="border-b border-blue-gray-100 p-4">Total</td>
                                    <td className="border-b border-blue-gray-100 p-4">{formatCurrency(
                                    laporan
                                      .filter((item) => item.month === selectedMonth)
