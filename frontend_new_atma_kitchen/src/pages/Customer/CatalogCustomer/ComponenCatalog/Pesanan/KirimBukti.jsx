...
import { sendBukti } from "../../../../../api/CustomerApi/Pesanan/PesananApi";

const KirimBukti = ({ pesanan, totalHarga}) => {
  const [open, setOpen] = useState(false);
  const [isPending, setIsPending] = useState(false);
  const [data, setData] = useState({ bukti_pembayaran: null, id_pesanan: pesanan.id });
