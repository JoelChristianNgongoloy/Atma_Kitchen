          ...
          {pesanan?.length > 0 ? (
            <>
              {pesanan.map((pesananItem) => (
                <div
                  key={pesananItem.id} // Menggunakan pesananItem.id sebagai key
                ...
                >
                  ...
                  <div className="">
                    <ul>
                      {pesananItem.detail_pesanan?.map((detailItem) => (
                        <div
                          className="border border-gray-200 shadow-lg rounded-md mb-6 flex items-center"
                          key={detailItem.id} // Menggunakan detailItem.id sebagai key
                        >
