...
import { GetAllPencatatanBahanOwner } from "../../../api/OwnerApi/apiLaporan";
      ...
      <Card className="h-full w-full" ref={componentRef}>
        ...
        >
          <div>
            ...
            <h1 className="font-bold text-xl underline">Laporan Stok Bahan Baku</h1>
            <h1 className="text-xl">Tanggal: {today}</h1>
          </div>
          {isLoading ? (
