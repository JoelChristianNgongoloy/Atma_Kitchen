...
export const GetKuota = async (idProduk) => {
  try {
    const response = await useAxios.get(`/kuotaproduk/${idProduk}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const AddKuota = async (idProduk, data) => {
  try {
    const response = await useAxios.post(`/kuotaproduk/${idProduk}`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
