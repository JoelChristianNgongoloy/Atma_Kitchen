              ...
              <table className="w-full min-w-max table-auto text-left">
                ...
                <tbody>
                  {laporan
                    ...
                    <tr>
                                    <td colSpan={1} className="border-b border-blue-gray-100 p-4">Total</td>
                                    <td className="border-b border-blue-gray-100 p-4">Rp.{laporan
                              .filter((item) => item.month === selectedMonth).reduce((acc, curr) => acc + curr.Pemasukkan, 0)}</td>
                              <td className="border-b border-blue-gray-100 p-4">Rp.{laporan
                              .filter((item) => item.month === selectedMonth).reduce((acc, curr) => acc + curr.Pengeluaran, 0)}</td>
                              </tr>
                </tbody>
              </table>
            </div>
